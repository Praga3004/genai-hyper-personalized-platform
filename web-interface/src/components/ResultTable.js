          ...
          {results.map((r, i) => (
            <tr key={r.id || i}>
              ...
              <td>
                    {r.image_url ? (
                      <img
                        src={`https://genai-hyper-personalized-platform-vxg3-olye0rms7-a-xtr-labs.vercel.app:8000${r.image_url}`}
                        alt="Generated"
                        style={{
                          width: "120px",
                          height: "120px",
              ...
              <td>
                    {r.audio_url ? (
                      <audio 
                        controls 
                        style={{ width: "160px" }}
                        src={`https://genai-hyper-personalized-platform-vxg3-olye0rms7-a-xtr-labs.vercel.app:8000${r.audio_url}`}
                      >
