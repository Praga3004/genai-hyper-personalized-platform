...
function App() {
  ...
  const handleFileUpload = (file) => {
    ...
    readExcelFile(file)
      .then((parsed) => {
        ...
        return fetch("https://genai-hyper-personalized-platform-v.vercel.app/api/classify-voter", {
          method: "POST",
  ...
  const handleGenerate = () => {
    ...
    fetch("https://genai-hyper-personalized-platform-v.vercel.app/api/generate-campaign", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
