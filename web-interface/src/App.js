...
function App() {
  ...
  const handleFileUpload = (file) => {
    ...
    readExcelFile(file)
      .then((parsed) => {
        ...
        return fetch("https://genai-hyper-personalized-platform-vxg3-olye0rms7-a-xtr-labs.vercel.app:8000/api/classify-voter", {
          method: "POST",
  ...
  const handleGenerate = () => {
    ...
    fetch("https://genai-hyper-personalized-platform-vxg3-olye0rms7-a-xtr-labs.vercel.app:8000/api/generate-campaign", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
